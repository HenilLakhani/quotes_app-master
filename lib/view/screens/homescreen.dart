...
import 'package:quotes_app/model/imageList.dart';
import 'package:quotes_app/model/like_modal.dart';
import 'package:quotes_app/model/quotes_modal.dart';
import 'package:quotes_app/view/screens/Like.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      String jasonDta = await rootBundle.loadString("assets/json/quotes.json");
